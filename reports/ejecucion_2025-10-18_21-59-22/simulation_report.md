...
**Fecha de generación:** 2025-10-18 21:59:27
...
- **Directorio de imágenes:** `reports\ejecucion_2025-10-18_21-59-22\images`
...
- **Movimientos totales:** 464
- **Exploración máxima alcanzada:** 3.50%
...
**Robot 1** (ID: `robot_0_`)
- Estado: Activo
- Movimientos realizados: 24
- Rotaciones realizadas: 59
- Colisiones con zonas vacías: 17
- Monstruos destruidos: 0

**Robot 2** (ID: `robot_1_`)
- Estado: Activo
- Movimientos realizados: 53
- Rotaciones realizadas: 24
- Colisiones con zonas vacías: 23
- Monstruos destruidos: 0

**Robot 3** (ID: `robot_2_`)
- Estado: Activo
- Movimientos realizados: 30
- Rotaciones realizadas: 57
- Colisiones con zonas vacías: 13
- Monstruos destruidos: 0

**Robot 4** (ID: `robot_3_`)
- Estado: Activo
- Movimientos realizados: 26
- Rotaciones realizadas: 61
- Colisiones con zonas vacías: 13
- Monstruos destruidos: 0
...
- Rotaciones realizadas: 50
- Colisiones con zonas vacías: 9
- Monstruos destruidos: 1
...
- Movimientos totales de monstruos: 320
- Promedio de movimientos por monstruo: 32.00
...
- **Iteración 70:** Robot robot_4_ destruyó un monstruo en posición (14, 4, 0)
...
4. **Cobertura:** Explorar hasta 3.50% del espacio disponible
...
**Reporte generado automáticamente el 2025-10-18 21:59:27**
