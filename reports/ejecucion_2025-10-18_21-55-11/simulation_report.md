...
**Fecha de generación:** 2025-10-18 21:55:15
...
- **Probabilidad de movimiento de monstruos:** 40.0%

### 3.3 Parámetros de la Simulación

- **Máximo de iteraciones:** 100
- **Generación de imágenes:** Sí
- **Directorio de imágenes:** `reports\ejecucion_2025-10-18_21-55-11\images`
...
- **Movimientos totales:** 275
- **Exploración máxima alcanzada:** 3.61%
...
**Robot 5** (ID: `robot_4_`)
- Estado: Activo
- Movimientos realizados: 10
- Rotaciones realizadas: 81
...
- Movimientos totales de monstruos: 129
- Promedio de movimientos por monstruo: 12.90
...
4. **Cobertura:** Explorar hasta 3.61% del espacio disponible
...
**Reporte generado automáticamente el 2025-10-18 21:55:15**
