...
**Fecha de generación:** 2025-10-18 23:08:55
...
- **Directorio de imágenes:** `reports\ejecucion_2025-10-18_23-08-50\images`
...
- **Movimientos totales:** 312
- **Exploración máxima alcanzada:** 0.33%
...
- Rotaciones realizadas: 51
- Colisiones con zonas vacías: 4
- Monstruos destruidos: 0

**Robot 2** (ID: `robot_1_`)
- Estado: Activo
- Movimientos realizados: 2
- Rotaciones realizadas: 71
- Colisiones con zonas vacías: 5
- Monstruos destruidos: 0

**Robot 3** (ID: `robot_2_`)
- Estado: Activo
- Movimientos realizados: 4
- Rotaciones realizadas: 48
- Colisiones con zonas vacías: 1
- Monstruos destruidos: 0
...
- Movimientos totales de monstruos: 299
- Promedio de movimientos por monstruo: 29.90
...
- **Iteración 6:** Robot robot_4_ destruyó un monstruo en posición (14, 1, 0)
...
4. **Cobertura:** Explorar hasta 0.33% del espacio disponible
...
**Reporte generado automáticamente el 2025-10-18 23:08:55**
