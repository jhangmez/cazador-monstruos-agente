...
**Fecha de generación:** 2025-10-19 11:07:02
...
- **Porcentaje de zonas libres:** 85.0%
- **Porcentaje de zonas vacías:** 15.0%
...
- **Directorio de imágenes:** `reports\ejecucion_2025-10-19_11-06-51\images`
...
- **Robots iniciales:** 5
- **Robots finales (activos):** 4
- **Robots sacrificados:** 1
- **Monstruos iniciales:** 10
- **Monstruos finales:** 9
- **Monstruos destruidos:** 1
- **Movimientos totales:** 588
- **Exploración máxima alcanzada:** 4.89%

### 7.2 Métricas de Desempeño

- **Eficiencia de destrucción:** 0.20 monstruos por robot
- **Tasa de éxito:** 10.00% de monstruos eliminados
- **Tasa de sacrificio:** 20.00% de robots perdidos
...
**Robots que completaron la simulación:** 4
**Robots destruidos (con monstruos):** 1

#### Estadísticas por Robot:

**Robot 1** (ID: `robot_0_`)
- Estado: Destruido
- Movimientos realizados: 42
- Rotaciones realizadas: 16
- Colisiones con zonas vacías: 16
- Monstruos destruidos: 1

**Robot 2** (ID: `robot_1_`)
- Estado: Activo
- Movimientos realizados: 57
- Rotaciones realizadas: 24
- Colisiones con zonas vacías: 18
- Monstruos destruidos: 0

**Robot 3** (ID: `robot_2_`)
- Estado: Activo
- Movimientos realizados: 54
- Rotaciones realizadas: 22
- Colisiones con zonas vacías: 17
- Monstruos destruidos: 0

**Robot 4** (ID: `robot_3_`)
- Estado: Activo
- Movimientos realizados: 62
- Rotaciones realizadas: 19
- Colisiones con zonas vacías: 13
- Monstruos destruidos: 0

**Robot 5** (ID: `robot_4_`)
- Estado: Activo
- Movimientos realizados: 52
- Rotaciones realizadas: 26
- Colisiones con zonas vacías: 18
- Monstruos destruidos: 0
...
- Movimientos totales de monstruos: 321
- Promedio de movimientos por monstruo: 32.10
...
**Eventos de destrucción:** 1

### Primeros 10 Eventos de Destrucción:

- **Iteración 74:** Robot robot_0_ destruyó un monstruo en posición (14, 5, 0)
...
El sistema logró destruir **1** de **10** monstruos (10.0% del total), 
sacrificando **1** de **5** robots (20.0%).
...
4. **Cobertura:** Explorar hasta 4.89% del espacio disponible
...
- **Eficiencia:** 0.20 monstruos por robot
...
**Reporte generado automáticamente el 2025-10-19 11:07:02**
